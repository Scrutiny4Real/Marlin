...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 47.795 // mm
  ...
  #define DELTA_DIAGONAL_ROD 140.0 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 147.40 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 63.0 //mm  Get this value from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 291.0262 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define HOMING_FEEDRATE_Z  (50*60) //vorher 200*60
...
//  M300 S<frequency Hz> P<duration ms>s
//
